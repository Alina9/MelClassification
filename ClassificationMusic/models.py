...
class CrnnModel(nn.Module):
    def __init__(self):
        ...
        self.GruLayer = nn.LSTM(input_size=2048,
                               hidden_size=256//2,
                               num_layers=1,
                               batch_first=True,
                               bidirectional=True)
...
class CrnnLongModel(nn.Module):
    def __init__(self):
        ...
        self.GruLayer = nn.LSTM(input_size=1024,
                               hidden_size=256//2,
                               num_layers=1,
                               batch_first=True,
                               bidirectional=True)

        self.GruLayerF = nn.Sequential(nn.BatchNorm1d(512),
                                       nn.Dropout(0.5))
        ...
        self.output = nn.Sequential(nn.Linear(in_features=128, out_features=10))
...
class RnnModel(nn.Module):
    ...
    def forward(self, inp):
        ...
        inp = inp.unsqueeze(1).transpose(3, 2)
